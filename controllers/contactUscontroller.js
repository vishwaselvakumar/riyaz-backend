...
const Contact = require('../modals/contactUsModel'); // Import your MongoDB model
...
exports.sendMessage = async (req, res) => {
    ...
    try {
        ...
        const newContact = new Contact({ firstname, email, phone, message,companyname });
...
exports.getContactMessages = async (req, res) => {
    try {
      const messages = await Contact.find(); // Fetch all contact messages
